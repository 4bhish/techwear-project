  ...
  return loadingStatus ? (
    ...
    <div className="productspage">
      ...
      <div className="products-container">
          ...
          <Drawer open={openFilter} onClose={toggleDrawer(false)}>
            <div className="drawer-filter-section">
              <div className="drawer-filter-container">
                <div className="drawer-filter-section-heading">
                  <h3>Filter</h3>
                  <p onClick={handleClear}>Clear</p>
                </div>
                ...
                <div className="drawer-ratings-section">
                  <h3>Ratings</h3>
                  <label htmlFor="five-rating">
                    <input
                      type="radio"
                ...
                <div className="drawer-sort-filter-section">
                  <h3>Sort By</h3>
                  <select
                    value={sorting}
                    onChange={(e) => setSorting(e.target.value)}
        ...
        <p className="toggle-filters" onClick={() => setOpenFilter(true)}>
          Filters
        </p>
        <h3>
